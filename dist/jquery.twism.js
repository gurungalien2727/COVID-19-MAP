...
*/
          $("svg path, svg rect, svg text", that).on("mouseclick", function(e) {
            if (ics && ics.length) {
          ...
          $("svg path, svg text, svg rect", that).on("mouseclick", function(e) {
            var country = $(e.target).attr("id");
            $('path#' + country+', rect#' + country, that).css({
              "fill": settings.color,
              "stroke": settings.border
    ...
    var setCountrySettings = function(options) {
        if (options.color) {
          ...
          $("svg path#" + options.name+", svg rect#" + options.name).on("mouseclick", function() {
            $(this).css({
              fill: options.color
            });
          });
      ...
      /*  if (options.hoverColor) {
        ...
        if (options.hover) {
          $("svg path#" + options.name + ", svg text#" + options.name+", svg rect#" + options.name).on("mouseclick", function(e) {
            e.stopPropagation()
            lastclicked = $(e.target).attr("id");
